...
def points_to_segments(gdf):
    ...
    results = []
    for callsign, group in tqdm(desc='Converting vessel points to segments', iterable=gdf.groupby('callsign')):
    ...
    out['timestamp'] = out['timestamp'].astype(int) // 10 ** 9
